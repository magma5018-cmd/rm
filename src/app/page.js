        ...
        <div className="page-body">
          ...
          {activeMenu === 'analytics' && (
            <div className="analytics-body" style={{ display: 'flex', flexDirection: 'column', gap: '32px', padding: '10px' }}>
              ...
              {/* 통계 카드 (4개 카드 모두 💡하단설명 박스 100% 디자인 통일) */}
                ...
                >
                  ...
                  <div style={{ borderTop: '1px dashed var(--border)', paddingTop: '16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                      ...
                      <span style={{ fontSize: '1.15rem', fontWeight: 800, color: '#ef4444' }}>₩ {dashboardStats.totalLoss.toLocaleString()}</span>
                    </div>
                    <div style={{ fontSize: '0.68rem', color: '#991b1b', lineHeight: 1.3, background: '#fff5f5', padding: '6px 8px', borderRadius: '4px', border: '1px solid #fecdd3' }}>
                      💡 <strong>클레임 종결</strong> : 배상/회수(구상+보험) 완료 건
                    </div>
                  </div>
                </div>
