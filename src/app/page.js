        ...
        <div className="page-body">
          ...
          {activeMenu === 'analytics' && (
            <div className="analytics-body" style={{ display: 'flex', flexDirection: 'column', gap: '32px', padding: '10px' }}>
              ...
              {/* 통계 카드 (아이콘 교체, 건수 추가, 높이 100% 나란히 수평 일치) */}
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
                ...
                >
                  ...
                  <div style={{ borderTop: '1px dashed var(--border)', paddingTop: '14px', display: 'flex', flexDirection: 'column', gap: '8px', flex: 1, justifyContent: 'space-between' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                      <span style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>접수 건수</span>
                      <span style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--text)' }}>{dashboardStats.totalCount} 건</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                      <span style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>발생액 합계</span>
                      <span style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--text)' }}>₩ {dashboardStats.totalOccur.toLocaleString()}</span>
                    </div>
                    <div style={{ fontSize: '0.68rem', color: '#475569', lineHeight: 1.3, background: '#f8fafc', padding: '6px 8px', borderRadius: '4px', border: '1px solid #e2e8f0' }}>
                      💡 <strong>전체 접수건</strong> : 발생된 사고의 총 건수 및 발생 금액<br />
                      💡 (미완료 및 종결 건 전체 포함)
                    </div>
                  </div>
                </div>

                {/* 2️⃣ 종결 (클레임없음) - 🎉 폭죽 아이콘 이동 */}
                <div 
                  className="panel" 
                ...
                >
                  ...
                  <div style={{ borderTop: '1px dashed var(--border)', paddingTop: '14px', display: 'flex', flexDirection: 'column', gap: '8px', flex: 1, justifyContent: 'space-between' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                      ...
                      <span style={{ fontSize: '1.3rem', fontWeight: 800, color: '#10b981' }}>{dashboardStats.totalNoClaimCount} 건</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                      <span style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>사고액 합계</span>
                      <span style={{ fontSize: '1.25rem', fontWeight: 800, color: '#10b981' }}>₩ {dashboardStats.totalNoClaimOccur.toLocaleString()}</span>
                    </div>
                    <div style={{ fontSize: '0.68rem', color: '#166534', lineHeight: 1.3, background: '#f0fdf4', padding: '6px 8px', borderRadius: '4px', border: '1px solid #bbf7d0' }}>
                      💡 <strong>면책/무이의</strong> : 손실 비용 발생 없이 깔끔하게 종결된 건<br />
                      💡 (회사 순 손실 0원)
                    </div>
                  </div>
                </div>

                {/* 3️⃣ 종결 (클레임처리) - 🧾 영수증/클레임 정산 아이콘으로 교체 & 종결 건수 추가 */}
                <div 
                  className="panel" 
                ...
                >
                  ...
                  <div style={{ borderTop: '1px dashed var(--border)', paddingTop: '14px', display: 'flex', flexDirection: 'column', gap: '6px', flex: 1, justifyContent: 'space-between' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                      <span style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>종결 건수</span>
                      <span style={{ fontSize: '1.15rem', fontWeight: 800, color: '#ef4444' }}>{dashboardStats.totalCompCount || (dashboardStats.totalCount - dashboardStats.totalNoClaimCount)} 건</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                      <span style={{ fontSize: '0.72rem', color: 'var(--text-muted)' }}>배상/회수액</span>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                      <span style={{ fontSize: '0.72rem', color: 'var(--text-muted)', fontWeight: 700 }}>회사 순 손실</span>
                      <span style={{ fontSize: '1.05rem', fontWeight: 800, color: '#ef4444' }}>₩ {dashboardStats.totalLoss.toLocaleString()}</span>
                    </div>
                    <div style={{ fontSize: '0.68rem', color: '#991b1b', lineHeight: 1.3, background: '#fff5f5', padding: '6px 8px', borderRadius: '4px', border: '1px solid #fecdd3' }}>
                      💡 <strong>클레임 종결</strong> : 배상/회수(구상+보험) 정산 완료 건
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div style={{ borderTop: '1px dashed var(--border)', paddingTop: '14px', display: 'flex', flexDirection: 'column', gap: '8px', flex: 1, justifyContent: 'space-between' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                      ...
                      <span style={{ fontSize: '1.3rem', fontWeight: 800, color: '#f59e0b' }}>{dashboardStats.totalCount - dashboardStats.totalNoClaimCount} 건</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                      <span style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>대상액 합계</span>
                      <span style={{ fontSize: '1.25rem', fontWeight: 800, color: '#f59e0b' }}>₩ {(dashboardStats.totalOccur - dashboardStats.totalNoClaimOccur).toLocaleString()}</span>
                    </div>
                    <div style={{ fontSize: '0.68rem', color: '#92400e', lineHeight: 1.3, background: '#fffbeb', padding: '6px 8px', borderRadius: '4px', border: '1px solid #fef3c7' }}>
                      💡 <strong>진행중 사건</strong> : 현재 보상/구상 절차가 진행 중인 건<br />
                      💡 (손실 미확정 단계)
                    </div>
                  </div>
                </div>
