...
9. [상세 사고 경위 서술 핵심 규칙 - 최우선 반영 요구]
   - '섹션 2. 사고 원인 및 경위' 내의 상세 사고 경위 (육하원칙) 항목은 아래에 제공된 육하원칙 5개 항목(누가/언제/어디서/무엇을/어떻게-왜)을 개별적으로 반드시 전부 활용하여 최대한 구체적이고 상세하게 서술할 것.
   - 각 항목에 기재된 고유명사(회사명, 담당자명), 지명, 물품명, 날짜, 수량, 사고 상황 묘사 등의 세부 데이터를 그대로 활용하여 경위서를 최대한 풍부하게 구성할 것.
   - 육하원칙 항목이 빈칸이 아닌 이상 절대로 내용을 임의로 축약하거나 생략하지 말 것.
   - 전달된 5개의 육하원칙 항목 값을 각각 별도의 소항목(예: **[누가]**, **[언제]**, **[어디서]** 등)으로 구분하여 나열하고, 그 이후에 이를 통합하는 서술형 사고 경위 단락을 추가로 구성할 것.
